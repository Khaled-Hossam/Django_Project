...
from countries.models import City,Sight
...
class CarReservationRequest(models.Model):
    ...
    pick_up_point = models.ForeignKey(Sight,related_name='pick_up_point')
    destination = models.ForeignKey(Sight,related_name='destination')
